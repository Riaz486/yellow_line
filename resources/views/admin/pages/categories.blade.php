        ...
        <div class="col-md-7 align-self-center text-right">
            <div class="d-flex justify-content-end align-items-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{url('admin/'.$postType)}}">Posts</a></li>
                    <li class="breadcrumb-item active">Categories</li>
                </ol>

                <a href="{{url('admin/'.$postType)}}" class="btn btn-info d-none d-lg-block m-l-15">
                            ...
                            <?php foreach($mainCategories as $data): ?>    
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        &nbsp;
                                        <a href="{{url('admin/'.$postType.'/deleteCategory/' . $data->id)}}" onclick="return confirm('Want to delete the category');">
        ...
        <div class="col-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{url('admin/create-category')}}">
                        {{csrf_field()}}
                            ...
                            <select name="category[parentID]" class="form-control">
                                ...
                                <?php foreach($categoriesData as $category): ?>
                                    <?php if($category['parentID'] == 0): // Only top-level categories ?>
                                        ...
                                        <?php if (!empty($category['children'])): // Check if this category has children ?>
                        ...
                        <input type="hidden" name="category[postType]" value="{{$postType}}" />
