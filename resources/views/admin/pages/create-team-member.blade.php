...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor">Manage Team Member</h4>
        </div>
        <div class="col-md-7 align-self-center text-right">
            <div class="d-flex justify-content-end align-items-center">
                ...
                <a href="{{url('admin/team-members/')}}" class="btn btn-info d-none d-lg-block m-l-15">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title"><?= ($id == '') ? 'Create' : 'Edit'; ?> Team Member</h4>
                    ...
                    <form method="POST" action="{{url('admin/process-widget')}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group col-6">
                            ...
                            <select class="form-control" name="widget[categoryID]" required>
                        ...
                        <input type="hidden" name="response" value="team" />
                        <input type="hidden" name="processType" value="team_members" />
